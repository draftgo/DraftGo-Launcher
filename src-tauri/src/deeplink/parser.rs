...
//!
//! Parses draftgo:// URLs into DeepLinkImportRequest structures.
...
/// Parse a draftgo:// URL into a DeepLinkImportRequest
///
/// Expected format:
/// draftgo://v1/import?resource={type}&...
pub fn parse_deeplink_url(url_str: &str) -> Result<DeepLinkImportRequest, AppError> {
    ...
    if scheme != "draftgo" {
        return Err(AppError::InvalidInput(format!(
            "Invalid scheme: expected 'draftgo', got '{scheme}'"
        )));
    }
