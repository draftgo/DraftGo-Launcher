//! Deep link import functionality for DraftGo Launcher
//!
//! This module implements the draftgo:// protocol for importing configurations
...
///
/// Represents a parsed draftgo:// URL ready for processing.
