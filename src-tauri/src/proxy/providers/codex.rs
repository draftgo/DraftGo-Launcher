...
/// Switch through the Responses API, so DraftGo Launcher bridges Responses ⇄ Anthropic.
///
...
/// managed xAI (Grok) OAuth provider — the first strict gateway draftgo-launcher hit.
