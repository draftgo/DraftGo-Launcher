...
//!
//! Handles conversion between DraftGo Launcher unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | DraftGo Launcher unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// DraftGo Launcher has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: DraftGo Launcher -> Hermes
// ============================================================================

/// Convert DraftGo Launcher unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> DraftGo Launcher
// ============================================================================

/// Convert Hermes format to DraftGo Launcher unified format
///
/// Conversion rules:
...
/// `existing` — this prevents DraftGo Launcher from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive DraftGo Launcher round-trip"
        );
    }
