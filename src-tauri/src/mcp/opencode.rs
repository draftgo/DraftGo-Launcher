...
//!
//! 本模块处理 DraftGo Launcher 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | DraftGo Launcher 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
// ============================================================================
// Format Conversion: DraftGo Launcher → OpenCode
// ============================================================================

/// Convert DraftGo Launcher unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → DraftGo Launcher
// ============================================================================

/// Convert OpenCode format to DraftGo Launcher unified format
///
/// Conversion rules:
