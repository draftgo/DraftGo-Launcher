    ...
    try {
      ...
      if (!displayVersion) {
        await settingsApi.openExternal(
          "https://github.com/draftgo/DraftGo-Launcher/releases",
        );
        return;
      }

      await settingsApi.openExternal(
        `https://github.com/draftgo/DraftGo-Launcher/releases/tag/${displayVersion}`,
      );
    } catch (error) {
          ...
          <div className="flex items-center gap-8">
            <div className="flex flex-col items-center gap-2">
              <div className="flex items-center gap-2">
                <img src={appIcon} alt="DraftGo Launcher" className="h-5 w-5" />
