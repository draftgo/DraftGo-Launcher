...
DraftGo Launcher v3.8.0 is a major architectural upgrade that restructures the data persistence layer and user interface, laying the foundation for future cloud sync and local proxy features.
...
- **Windows**: `DraftGo-Launcher-v3.8.0-Windows.msi` or `-Portable.zip`
- **macOS**: `DraftGo-Launcher-v3.8.0-macOS.tar.gz` or `.zip`
- **Linux**: `DraftGo-Launcher-v3.8.0-Linux.AppImage` or `.deb`
...
- [@draftgo](https://github.com/draftgo) - Bug fixes and feature enhancements
...
[Use code "draftgo-launcher" for 10% off registration](https://www.packyapi.com/register?aff=draftgo-launcher)
...
- **Issue Reports**: [GitHub Issues](https://github.com/draftgo/DraftGo-Launcher/issues)
