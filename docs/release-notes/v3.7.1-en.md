...
- **ArchLinux Installation Support** (#259)
  Added AUR installation method: `paru -S draftgo-launcher-bin`
...
Visit [Releases](https://github.com/draftgo/DraftGo-Launcher/releases/latest) to download the latest version
...
- **Deep link integration** - Import via `draftgo://` protocol
...
v3.7.0 represents a shift in DraftGo Launcher's positioning:
...
Visit [Releases](https://github.com/draftgo/DraftGo-Launcher/releases/latest) to download:

- **Windows**: `DraftGo-Launcher-Windows.msi` or `-Portable.zip`
- **macOS**: `DraftGo-Launcher-macOS.tar.gz` or `.zip`
- **Linux**: `DraftGo-Launcher-Linux.AppImage` or `.deb`
- **ArchLinux**: `paru -S draftgo-launcher-bin`
...
- [@draftgo](https://github.com/draftgo) - From developer to issue responder
...
[Register with "draftgo-launcher" code for 10% discount](https://www.packyapi.com/register?aff=draftgo-launcher)
...
- **Issues**: [GitHub Issues](https://github.com/draftgo/DraftGo-Launcher/issues)
- **Discussions**: [GitHub Discussions](https://github.com/draftgo/DraftGo-Launcher/discussions)
