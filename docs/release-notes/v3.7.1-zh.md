...
- **ArchLinux 安装支持** (#259)
  添加 AUR 安装方式：`paru -S draftgo-launcher-bin`
...
访问 [Releases](https://github.com/draftgo/DraftGo-Launcher/releases/latest) 下载最新版本
...
v3.7.0 代表了 DraftGo Launcher 定位的转变：
...
访问 [Releases](https://github.com/draftgo/DraftGo-Launcher/releases/latest) 下载：

- **Windows**：`DraftGo-Launcher-Windows.msi` 或 `-Portable.zip`
- **macOS**：`DraftGo-Launcher-macOS.tar.gz` 或 `.zip`
- **Linux**：`DraftGo-Launcher-Linux.AppImage` 或 `.deb`
...
- [@draftgo](https://github.com/draftgo) - 从开发沦为 issue 回复机
- 社区成员的测试和反馈
...
[使用 "draftgo-launcher" 优惠码注册享 9 折优惠](https://www.packyapi.com/register?aff=draftgo-launcher)
...
- **问题反馈**：[GitHub Issues](https://github.com/draftgo/DraftGo-Launcher/issues)
- **讨论**：[GitHub Discussions](https://github.com/draftgo/DraftGo-Launcher/discussions)
