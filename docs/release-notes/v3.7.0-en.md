...
DraftGo Launcher v3.7.0 introduces six major features with over 18,000 lines of new code.
...
- **Windows**: `DraftGo-Launcher-v3.7.0-Windows.msi` or `-Portable.zip`
- **macOS**: `DraftGo-Launcher-v3.7.0-macOS.tar.gz` or `.zip`
- **Linux**: `DraftGo-Launcher-v3.7.0-Linux.AppImage` or `.deb`
