...
**[Use DraftGo Launcher to configure, manage, and switch Claude Desktop providers in one place](../user-manual/en/2-providers/2.6-claude-desktop.md)**
...
DraftGo Launcher now treats **Claude Desktop** as a first-class managed surface alongside Claude Code / Codex / Gemini / OpenCode / OpenClaw / Hermes.

- New dedicated Claude Desktop panel that brokers third-party providers to Claude Desktop through DraftGo Launcher's in-app proxy gateway
...
ChatGPT Codex providers no longer rely on a hardcoded model selection — DraftGo Launcher fetches a **live model list** from the ChatGPT backend on demand.
...
Switching a Claude Desktop provider writes DraftGo Launcher's managed 3P profile and **requires restarting Claude Desktop** to take effect; proxy-mode providers require DraftGo Launcher's Local Routing to stay running while in use.
...
### DraftGo Launcher Brand Surface Unified to github.com/draftgo/DraftGo-Launcher

All in-app and README "official website" references now point at github.com/draftgo/DraftGo-Launcher as the sole official site; the release notes template also surfaces github.com/draftgo/DraftGo-Launcher.
...
The release notes template now surfaces `github.com/draftgo/DraftGo-Launcher`.

### Brand Surface

Documented `github.com/draftgo/DraftGo-Launcher` as the sole official website across READMEs and in-app references.
...
| File                                     | Description                                           |
| ---------------------------------------- | ----------------------------------------------------- |
| `DraftGo-Launcher-v3.15.0-Windows.msi`          | **Recommended** - MSI installer, supports auto-update |
| `DraftGo-Launcher-v3.15.0-Windows-Portable.zip` | Portable, extract and run, no registry writes         |

### macOS

| File                             | Description                                             |
| -------------------------------- | ------------------------------------------------------- |
| `DraftGo-Launcher-v3.15.0-macOS.dmg`    | **Recommended** - DMG installer, drag into Applications |
| `DraftGo-Launcher-v3.15.0-macOS.zip`    | Extract and drag into Applications, Universal Binary    |
| `DraftGo-Launcher-v3.15.0-macOS.tar.gz` | For Homebrew installation and auto-update               |
...
>
> - `DraftGo-Launcher-v3.15.0-Linux-x86_64.AppImage` / `.deb` / `.rpm`
> - `DraftGo-Launcher-v3.15.0-Linux-arm64.AppImage` / `.deb` / `.rpm`
