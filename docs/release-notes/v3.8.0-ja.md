...
DraftGo Launcher v3.8.0 はデータ永続化レイヤーと UI を大幅に作り替え、今後のクラウド同期やローカルプロキシ機能に向けた基盤を整えたメジャーアップデートです。
...
[Releases](https://github.com/draftgo/DraftGo-Launcher/releases/latest) から入手:

- **Windows**: `DraftGo-Launcher-v3.8.0-Windows.msi` または `-Portable.zip`
- **macOS**: `DraftGo-Launcher-v3.8.0-macOS.tar.gz` または `.zip`
- **Linux**: `DraftGo-Launcher-v3.8.0-Linux.AppImage` または `.deb`
...
- [@draftgo](https://github.com/draftgo) - バグ修正と機能拡張
...
[登録時に「draftgo-launcher」で 10% オフ](https://www.packyapi.com/register?aff=draftgo-launcher)
...
- **Issue**: [GitHub Issues](https://github.com/draftgo/DraftGo-Launcher/issues)
