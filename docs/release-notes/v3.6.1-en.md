# DraftGo Launcher v3.6.1

> Stability improvements and user experience optimization (based on v3.6.0)

**[中文更新说明 Chinese Documentation →](https://github.com/draftgo/DraftGo-Launcher/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- Download `DraftGo-Launcher-v3.6.1-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `DraftGo-Launcher-v3.6.1-Windows.msi`
- **Portable**: `DraftGo-Launcher-v3.6.1-Windows-Portable.zip`

#### Linux

- **AppImage**: `DraftGo-Launcher-v3.6.1-Linux.AppImage`
- **Debian**: `DraftGo-Launcher-v3.6.1-Linux.deb`

---

### 📚 Documentation

- [中文文档 (Chinese)](https://github.com/draftgo/DraftGo-Launcher/blob/main/README_ZH.md)
- [English Documentation](https://github.com/draftgo/DraftGo-Launcher/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/draftgo/DraftGo-Launcher/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/draftgo/DraftGo-Launcher/compare/v3.6.0...v3.6.1
...
- **Customizable Storage Location** - Customize DraftGo Launcher's configuration storage directory
...
## 🌟 About DraftGo Launcher

DraftGo Launcher is a cross-platform desktop application for managing and switching between different provider configurations for Claude Code and Codex. Built with Tauri 2.0 + React 18 + TypeScript, supporting Windows, macOS, and Linux.
...
**Project Repository**: https://github.com/draftgo/DraftGo-Launcher
