...
**[中文更新说明 Chinese Documentation →](https://github.com/draftgo/DraftGo-Launcher/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- Download `DraftGo-Launcher-v3.6.0-macOS.zip` from [Assets](#assets) below
...
- **Installer**: `DraftGo-Launcher-v3.6.0-Windows.msi`
- **Portable**: `DraftGo-Launcher-v3.6.0-Windows-Portable.zip`

### Linux

- **AppImage**: `DraftGo-Launcher-v3.6.0-Linux.AppImage`
- **Debian**: `DraftGo-Launcher-v3.6.0-Linux.deb`
...
**Full Changelog**: https://github.com/draftgo/DraftGo-Launcher/compare/v3.5.1...v3.6.0
