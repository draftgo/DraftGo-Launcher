...
## What is DraftGo Launcher

DraftGo Launcher is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**.
...
DraftGo Launcher solves these problems through a unified interface.
...
DraftGo Launcher is built with a modern technology stack:
