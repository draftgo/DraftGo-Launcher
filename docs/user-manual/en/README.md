...
| File | Description |
|------|-------------|
| [5.1-config-files.md](./5-faq/5.1-config-files.md) | DraftGo Launcher storage, CLI configuration file formats |
...
- Applicable to DraftGo Launcher v3.16.0+
...
- [GitHub Issues](https://github.com/draftgo/DraftGo-Launcher/issues)
- [GitHub Repository](https://github.com/draftgo/DraftGo-Launcher)
