...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (DraftGo Launcher)
...
After starting the proxy and enabling app takeover, DraftGo Launcher modifies app configurations:
...
When stopping the proxy, DraftGo Launcher will:
