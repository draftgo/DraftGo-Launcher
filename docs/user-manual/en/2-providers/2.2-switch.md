...
2. DraftGo Launcher updates the configuration file
...
1. Right-click the DraftGo Launcher icon in the system tray
...
When switching providers, DraftGo Launcher modifies the following files:
