...
DraftGo Launcher provides rich icon customization features:
...
This ensures DraftGo Launcher and CLI tool configurations stay in sync.
...
When adding a provider, DraftGo Launcher automatically extracts endpoint URLs from the configuration.
