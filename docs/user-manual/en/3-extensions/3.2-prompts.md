...
DraftGo Launcher provides a smart backfill protection mechanism to ensure your manual modifications are not lost.
...
```
draftgo://import/prompt?data=<base64-encoded preset>
```
