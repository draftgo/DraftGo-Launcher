...
**On macOS:**
- DraftGo Launcher launches your preferred terminal with the resume command
...
3. DraftGo Launcher launches the Claude terminal session in the selected directory
